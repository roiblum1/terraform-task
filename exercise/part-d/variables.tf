# ==============================================================================
# Part D — same as Part C, plus ansible_user for the generated inventory.
# ==============================================================================
...
# TODO: variable "ansible_user" — string, default "root". Written into the
# generated inventory as ansible_user under [student_vms:vars].
